...
class LocationFragment : Fragment(), GoogleMap.OnMapClickListener, OnMapReadyCallback {
    ...
    override fun onStart() {
        ...
        fusedLocationProviderClient.lastLocation.addOnSuccessListener {
            ...
            val cameraPosition = CameraPosition.Builder().target(getLocation).zoom(18f).tilt(45f).build()
    ...
    override fun onMapClick(point: LatLng) {
        ...
        val cameraPosition = CameraPosition.Builder().target(point).zoom(18f).tilt(45f).build()
        googleMap?.moveCamera(CameraUpdateFactory.newCameraPosition(cameraPosition))
